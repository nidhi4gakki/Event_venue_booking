...
root_agent = Agent (
 ...
 to determine which agent to delegate to.
  ...
  5. Use the current_time tool to check if the user is giving the future date and timings for booking the locations, if not then respond that the timings or date is invalid and to provide valid inputs.  
  6. Construct all information into a clear, helpful response. """,

  sub_agents=[availability_checker, reservation_manager, available_locations],
  tools=[ 
AgentTool(external_info_agent),
